...
내가 무엇을 더 알아야 소프트웨어를 개발하는데 도움이 되고 잘 할 수 있게 되는지, 지금의 내 방법으로도 잘 되고 있는데 왜 내가 잘 모르는 다른 방법을 쓰면 더 좋은지 이해가 안되서 공부가 필요하신 분들에게 도움이 되는 과정입니다. 최소한 자신이 공부를 할 의지를 가지고 있어야 제가 도움을 드릴 수 있습니다.

## 소개좀 자세히 해 주세요

저는 현재 버넥트에서 AR 관련 제품 개발 및 프로젝트 과제 개발을 하고 있습니다.
개인 과외를 거쳐 네이버 까페 등에서 무료 온라인 강의를 진행하다가 2018년 부터 새로운 활동을 진행하고 있습니다.
...
- 어찌됐든 시간이 지나면 돈은 주고 받지 않았지만 서로 이득이긴 합니다.
...
- 학교 과제를 저한테 시켜서 빨리 해결하고 싶으신 분
- 회사 실무 문제를 저한테 시켜서 해결하시려는 분
- 사람을 고용해서 해야 할 일을, 절 시켜서 해결 하시려는 분
- 아무 목적 없이 저와 함께 하면 뭔가 잘 알게 될거라는 기대를 가지신 분
- 제가 문제 같은 걸 주고 풀라고 시켜서 그 커리큘럼 대로 하면 실력이 있는 사람이 될거라 기대하시는 분 (전 커리큘럼을 가지고 있지 않을 뿐 아니라 이것 저것 해보라고 시키지 않습니다.)
