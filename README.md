...
- 2020 ~ 현재 대학원생과 함께 WebRTC와 증강현실 기술이 적용된 논문의 연구를 진행하고 있습니다.
...
- 조윤우님 + 정혜인님 팀
  ...
  - 정혜인님
    ...
    - 2020년 11월 부터 잠시 휴식 2021년 1월 부터 진행
  - 조윤우님이 2020년 8월 취업하여 현재까지 중단 상태
...
- 시작하게 된 계기
  - 2019 한이음 프로젝트에서 처음 만나 프로젝트 종료 후, home coming day에서 다시 만나게 됐고 고민을 듣고 멘토링 해 줄 수 있으니 연락달라고 얘기를 나눔
  - 이후 카톡으로 멘토링 할 것을 요청해왔고 진행하게 된 케이스
- 후기
...
- 시작하게 된 계기
  - 네이버 까페, 하드코딩 하는 사람들에서 공부 방향이나 조언을 구하는 글을 보고 댓글을 달게 됐고 멘토링도 가능하다는 댓글을 추가로 달아줌
  - 그리고 메일로 따로 연락을 해서 멘토링을 해주겠다는 제안을 하고 시작한 케이스
- 후기
  - 소프트웨어를 개발하기 위해서 알아야 하는 과정들에 대한 경험을 충분히 함
  - 알고리즘, 객체지향, 소프트웨어 라이프 사이클 등
...
- 나만의 청첩장 사이트
- 2020-01 ~ 2020-05 (두달간 중지했다가 다시 하기로 했지만 사실상 종료)
...
- 미팅
  - 온라인: 5회
- 시작하게 된 계기
  - 한번 시작한 후 중단했지만, home coming day에서 오랜만에 만나게 됐고 거기서 다시 새롭게 프로젝트를 시작해 보고 싶다는 얘기를 함
  - 하고 싶으면 언제든 연락 달라고 했고 나중에 메일을 받아 진행한 케이스
- 후기
...
- 미팅
  ...
  - 온라인: 2회
- 시작하게 된 계기
  - 임기민님과 멘토링 진행 중, 한이음에서 하반기 추가 모집을 한다는 걸 알려드리고 프로젝트를 시작할 걸 제안
  - 친한 친구들과 하려고 했다가 조건이 맞지 않아서 함께 못하게 됐지만, 프로젝트는 등록하고 진행하는 것으로 다시 제안
  - 프로젝트 등록 후 멘토를 자청하여 심의가 통과되고 진행
- 후기
...
- 미팅
  ...
  - 온라인: 3회
- 시작하게 된 계기
  - 하드코딩하는 사람들 2019 세미나에서, 조윤우님과 인연이 있는 분으로 소개 받음
  - 세미나 종료 이후에 많은 대화를 나누고 어떻게 멘토링이 진행되는지 설명 후
  - 약 2주 후에 멘토링 진행 의사를 밝힌 메일을 받고 진행하게 된 케이스
- 후기
