...
2016 ~ 2018년 네이버 까페 등에서 무료 온라인 강의를 진행하다가\
2018년 5월 부터 새로운 멘토링 활동을 여러 분야와 다양한 분들과 함게 진행하고 있습니다.\
...
- 저는 여러분들이 하려는 경험을 함께 공유하고 제가 여태까지 경험하지 못한 부분을 경험하게 됩니다.
...
주제 및 목표가 구체화 되고 정해지면 목표를 달성하기 위해 요구사항 분석, 설계, 구현을 필요한대로 진행하는 걸 권장하며 특별히 템플릿이나 정해진 규칙은 없습니다. 정해진 규칙이 없다고 해서 어렵게 생각하지 마시고 필요하다고 생각되는 부분을 저와 함께 얘기하면서 진행하시면 되고, 제가 적절한 힌트나 가이드 등을 드립니다.
특히 문서 작성할 때에는 읽고 이해할 수 있는 수준으로 적어 주시면 됩니다.
